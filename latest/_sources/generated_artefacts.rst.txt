...
.. code-block:: c
    ...
    * Generated from 'demo.ddd.json' by ddd 0.10.0.
    *
...
.. note::
   ...
   is reported by the ``schema`` check, one of the eight whose severity ``-W`` refuses to
...
usage error. The staging name is fixed rather than random so that a staging file a crashed
...
.. code-block:: text
   ...
   /* DemoDevice.a2l - generated from 'DemoDevice' by ddd 0.10.0. DO NOT EDIT. */
   ASAP2_VERSION 1 61

   /begin PROJECT DemoDevice "Demonstration project showing every kind of data object"

     /begin HEADER "Demonstration project showing every kind of data object"
       PROJECT_NO DemoDevice
       VERSION "generated by ddd 0.10.0"
     /end HEADER

     /begin MODULE DemoDevice "Demonstration project showing every kind of data object"
